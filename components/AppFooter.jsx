      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
          <div>
            <Link
              href="/"
              className="relative text-4xl font-semibold text-slate-900"
            >
              <span className="text-yellow-400">Voltaris</span>Shop
              <span className="text-yellow-400 text-5xl leading-none">.</span>
            </Link>
            <p className="max-w-[410px] mt-6 text-sm">
              Welcome to Voltaris Shop — your destination for modern,
              high-performance tech. From smart devices to essential
              accessories, we curate innovative products designed to power your
              digital lifestyle.
            </p>
        ...
        <p className="py-4 text-sm text-slate-500">
          ...
          <span className="font-medium text-slate-700">Voltaris Shop</span>.
          Powered by Voltaris Digital Solutions.
        </p>
      </div>
    </footer>
  );
