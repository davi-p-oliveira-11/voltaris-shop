    ...
    try {
      ...
      if (["approved", "rejected", "pending"].includes(data.status)) {
        ...
        switch (data.status) {
          ...
          case "rejected":
            setMessage(
              "Your store request has been reject, contact the admin for more information"
            );
            break;
          case "pending":
            setMessage(
          ...
          >
            ...
            <div>
              ...
              <p className="max-w-lg">
                To become a seller on VoltarisShop, submit your store details
                for review. Your store will be activated after admin
                verification.
              </p>
            </div>
